...
import { ArrowRight, Fish, ShoppingBag, BookOpen, TrendingUp, Users, CheckCircle, Sparkles, Loader2, Star } from "lucide-react";
    ...
    const fetchProducts = async () => {
      ...
      try {
        ...
        if (response.data && Array.isArray(response.data)) {
          setProducts(response.data); // Already limited to 3 products with highest rating
        }
      } catch (error) {
      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-8 py-20">
          <div className="text-center max-w-5xl mx-auto">
            ...
            {/* Main Heading */}
            <h1 
              className="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-8 leading-tight animate-fade-in-up"
              style={{ 
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {productsLoading ? (
              ...
              products.map((product) => (
                ...
                >
                  <div className="aspect-square bg-gradient-to-br from-blue-200 to-cyan-200 overflow-hidden relative">
                  ...
                  <div className="p-6">
                    <h4 className="font-bold text-xl text-gray-900 mb-2 group-hover:text-blue-600 transition-colors line-clamp-1">
                      {product.name}
                    </h4>
                        ...
                        <div className="flex items-center gap-1">
                          {[1, 2, 3, 4, 5].map((star) => (
                            <Star 
                              key={star}
                              size={16}
                              className={star <= Math.round(product.averageRating!) 
